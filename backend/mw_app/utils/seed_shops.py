...
from ..models import Shop, User, VERIFICATION_STATUS_VERIFIED, VERIFICATION_STATUS_PENDING, VERIFICATION_STATUS_UNDER_REVIEW, USER_ROLE_ADMIN, USER_ROLE_SELLER
